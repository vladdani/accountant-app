...
// Removed unused Tabler icons import

// Define the expected shape of a feature object
interface FeatureItem {
  title: string;
  description: string;
  icon: React.ReactNode; // Keep icon flexible
}
...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-300 max-w-xs relative z-10 px-6 leading-relaxed">
        {description}
      </p>
    </div>
  );
